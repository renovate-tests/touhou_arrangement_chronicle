...
circle.update_attributes(site_url: 'http://www16.big.or.jp/~zun/', blog_url: 'http://kourindou.exblog.jp/')
artist = Artist.find_or_create_by(name_ja: 'ZUN', name_en: 'ZUN', circle: circle)
artist.update_attributes(site_url: 'http://www16.big.or.jp/~zun/', blog_url: 'http://kourindou.exblog.jp/')
...
circle.update_attributes(site_url: 'https://www.tasofro.net/', blog_url: 'http://tasofro.net/diary/index.php')
artist = Artist.find_or_create_by(name_ja: 'あきやまうに', name_en: 'U2', circle: circle)
artist.update_attributes(site_url: 'https://www.tasofro.net/', blog_url: 'http://tasofro.net/diary/index.php')
artist.arranger || artist.create_arranger
artist.composer || artist.create_composer
